...
env.home = env.get('home', '/var/www/t1international')
env.repo = env.get('repo', 't1international')
env.media = env.get('media', 't1international')
env.database = env.get('database', 't1international_django')
